...
from tests.test_git import GIT_TESTS
from tests.test_github_sync import GITHUB_SYNC_TESTS
from tests.test_cleanup import CLEANUP_TESTS
...
def main():
    ...
    passed += run_plain(GIT_TESTS)
    passed += run_plain(GITHUB_SYNC_TESTS)
    passed += run_plain(CLEANUP_TESTS)
